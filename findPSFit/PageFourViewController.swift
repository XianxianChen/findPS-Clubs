...
class PageFourViewController: UIViewController {
    ...
    let clubNames = ["Golf Club", "Cruquet Club", "Bitcoin Club", "Thon Club", "Model Railroad Club", "Coffee Club", "Twirling Club","Karate Club", "Cross Country", "Baseball Club", "Outling Club", "Roller Hockey"]
    ...
    override func viewWillLayoutSubviews() {
        discoverLabel.layer.cornerRadius = 40
        discoverLabel.layer.masksToBounds = true
    }
...
extension PageFourViewController: UICollectionViewDataSource {
...
extension PageFourViewController: UICollectionViewDelegate {
